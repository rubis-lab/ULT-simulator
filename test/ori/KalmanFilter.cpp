...
/*
void KalmanFilter::SetX(gsl_matrix *X)	{	gsl_matrix_memcpy(this->X, X);	}
void KalmanFilter::SetU(gsl_matrix *U)	{	gsl_matrix_memcpy(this->U, U);	}
void KalmanFilter::SetA(gsl_matrix *A)	{	gsl_matrix_memcpy(this->A, A);	}
void KalmanFilter::SetB(gsl_matrix *B)	{	gsl_matrix_memcpy(this->B, B);	}
void KalmanFilter::SetH(gsl_matrix *H)	{	gsl_matrix_memcpy(this->H, H);	}
void KalmanFilter::SetQ(gsl_matrix *Q)	{	gsl_matrix_memcpy(this->Q, Q);	}
void KalmanFilter::SetR(gsl_matrix *R)	{	gsl_matrix_memcpy(this->R, R);	}
void KalmanFilter::SetP(gsl_matrix *P)	{	gsl_matrix_memcpy(this->P, P);	}
*/

...
void KFManager::setManager(KFArgument args)
{	
...
void getCorrectedResult(SoverResult *result)
{
...
void KFManager::SetMatrix(KalmanFilter* KF, 
...
void KFManager::RootConfP(double period, double measErr, double systemErr)
{
	for (int i = 0; i < 3; i++)
...
void KFManager::RootConfPV(double period, double measErr, double systemErr)
{	
	for (int i = 0; i < 3; i++)
...
void KFManager::RootConfPVA(double period, double measErr, double systemErr)
{
	mode = KF::PVA;
	for (int i = 0; i < 3; i++)
...
void KFManager::Predict()
{
	for (int i = 0; i < 3; i++)
		KF[i].fast_predict();
}

void KFManager::Correct(Vector &measurement)
{
...
void KFManager::initFilter(Vector &measurement)
{
